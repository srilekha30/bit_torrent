...
class PeerTCPClient:
    ...
    #sending data after establishing TCP connection
    ...
    def _populate_info(self, download_info: DownloadInfo, file_structure: FileStructure):
        ...
        self._piece_owned = bitarray(download_info.piece_count)   #which efficiently represents an array of booleans, it's like a list
    ...
    async def _receive_info(self) -> bytes:
        ...
        print("peer id", actual_peer_id )
        print(" info hash",actual_info_hash)
    ...
    def peer_interested(self):
        #print("** hi**",self._peer_interested)
    ...
    async def _handle_requests(self, message_id: MessageType, payload: memoryview):
        ...
        print("**",piece_index, begin, length,"***")
